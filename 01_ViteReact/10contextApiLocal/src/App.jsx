...
function App() {
  ...
  const addTodos = (todo) => { setTodos((prev) => [{ id: Date.now(), ...todo }, ...prev]) }
  ...
  useEffect(() => {
    localStorage.setElement("todos", JSON.stringify(todos))
  }, [todos])

  return (
    <TodoContextProvider value={{ todos, addTodos, updateTodo, deleteTodo, toggleComplete }}>
